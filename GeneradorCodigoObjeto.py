def generar_ensamblador_emu8086(cuadruplas, nombre_automata, tipo_automata):
    ...
    # ===================
    asm_code += ".data\n"
    asm_code += "    msg_accept db 'ACEPTADA', 0Dh, 0Ah, '$'\n"
    asm_code += "    msg_reject db 'RECHAZADA', 0Dh, 0Ah, '$'\n"
    ...
    asm_code += "    lcd_port dw 2040h  ; Puerto del LCD ASCII\n"
    ...
    asm_code += "    ; Mostrar salto de línea\n"
    asm_code += "    mov ah, 02h\n"
    asm_code += "    mov dl, 0Dh\n"
    asm_code += "    int 21h\n"
    asm_code += "    mov dl, 0Ah\n"
    asm_code += "    int 21h\n\n"
    asm_code += "    ; Mostrar palabra 'Cadena' y espacio\n"
    asm_code += "    mov ah, 02h\n"
    asm_code += "    mov dl, 'C'\n"
    asm_code += "    int 21h\n"
    asm_code += "    mov dl, 'a'\n"
    ...
    asm_code += "    mov dl, ' '\n"
    asm_code += "    int 21h\n\n"
    asm_code += "    ; Mostrar mensaje de aceptación\n"
    asm_code += "    mov ah, 09h\n"
    asm_code += "    mov dx, offset msg_accept\n"
    asm_code += "    int 21h\n\n"
    asm_code += "    ; Mostrar 'A' en LCD ASCII\n"
    asm_code += "    mov dx, [lcd_port]\n"
    asm_code += "    mov al, 'A'\n"
    asm_code += "    out dx, al\n"
    ...
    asm_code += "    mov dl, ' '\n"
    asm_code += "    int 21h\n\n"
    asm_code += "    ; Mostrar mensaje de rechazo\n"
    asm_code += "    mov ah, 09h\n"
    asm_code += "    mov dx, offset msg_reject\n"
    asm_code += "    int 21h\n\n"
    asm_code += "    ; Mostrar 'R' en LCD ASCII\n"
    asm_code += "    mov dx, [lcd_port]\n"
    asm_code += "    mov al, 'R'\n"
    asm_code += "    out dx, al\n\n"
